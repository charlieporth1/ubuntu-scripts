...
sendemail -f $USER@otih-oith.us.to -t charlieporth1@gmail.com -m "Virus Report from server $HOSTNAME" -a  /mnt/HDD/virus.txt -s smtp.gmail.com:587 -o tls=yes -xu chtiporth@gmail.com -xp $(echo $passwd)
...
sendemail -f $USER@otih-oith.us.to -t 9523341587@mms.att.net  -m "Virus Report from server" -a  /mnt/HDD/virus.txt -s smtp.gmail.com:587 -o tls=yes -xu chtiporth@gmail.com -xp (echo $passwd)
echo done
