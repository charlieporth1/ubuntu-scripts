...
alias health-check-log="tail -f $log/*health-check.log"
alias hc-log="health-check-log"
alias doh-log="sudo tail -f $log/nginx/doh-*.log"
alias bp-log="sudo tail -f $log/nginx/default-blockpage-*.log"
alias default-log="sudo tail -f $log/nginx/default-*.log"
alias blockpage-log="bp-log"
alias nginx-log="sudo tail -f $log/nginx/*.log"
alias nginx-rfc-log="tail -f $log/nginx-dns-rfc/*.log"
alias ctp-dns-log="tail -f $log/ctp-dns/*.log"
alias ctp-yt-log="tail -f $log/ctp-youtube-blocker/*.log"
alias ctp-yt-blocker-log="ctp-yt-log"
alias ctp-youtube-log="ctp-yt-log"
alias ctp-youtube-blocker-log="ctp-yt-log"
alias ctp-yt-ttl-log="tail -f $log/ctp-yt-ttl-dns/*.log"
alias ctp-youtube-ttl-log="ctp-yt-ttl-log"
alias dot-log="ctp-dns-log"
alias doq-log="ctp-dns-log"
#!/bin/bash
# enable color support of ls and also add handy aliases
#if [ -x /usr/bin/dircolors ]; then
#    test -r ~/.dircolors && eval "$(dircolors -b ~/.dircolors)" || eval "$(dircolors
...
alias dot-log="ctp-dns-log"
alias doq-log="ctp-dns-log"
alias query-youtube="pihole -q r5.sn-uhvcpax0n5-vgql.googlevideo.com"
alias query-yt="query-youtube"
alias query-pihole-yt="query-youtube"
#!/bin/bash
# enable color support of ls and also add handy aliases
#if [ -x /usr/bin/dircolors ]; then
#    test -r ~/.dircolors && eval "$(dircolors -b ~/.dircolors)" || eval "$(dircolors
