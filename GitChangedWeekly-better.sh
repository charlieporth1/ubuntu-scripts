...
sudo rclone delete -v Gdrive:HACK/exploit-database/.git/objects/pack| parallel
sudo echo 3 > /proc/sys/vm/drop_caches
sudo echo 2 > /proc/sys/vm/drop_caches
sudo echo 1 > /proc/sys/vm/drop_caches
...
sudo delete -v Gdrive:exploit-database-papers/.git/objects/pack | parallel
sudo echo 3 > /proc/sys/vm/drop_caches
sudo echo 2 > /proc/sys/vm/drop_caches
sudo echo 1 > /proc/sys/vm/drop_caches
else
...
sudo rclone delete -v Gdrive:HACK/exploit-database-bin-spoits/.git/objects/pack  | parallel
sudo echo 3 > /proc/sys/vm/drop_caches
sudo echo 2 > /proc/sys/vm/drop_caches
sudo echo 1 > /proc/sys/vm/drop_caches
